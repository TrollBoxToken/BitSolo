...
RESOURCES += src/qt/bitsolo.qrc src/qt/bitsolo_locale.qrc

TRANSLATIONS += src/qt/locale/bitsolo_bg.ts \
                src/qt/locale/bitsolo_de.ts \
                src/qt/locale/bitsolo_en.ts \
                src/qt/locale/bitsolo_es.ts \
                src/qt/locale/bitsolo_fi.ts \
                src/qt/locale/bitsolo_fr.ts \
                src/qt/locale/bitsolo_it.ts \
                src/qt/locale/bitsolo_ja.ts \
                src/qt/locale/bitsolo_pl.ts \
                src/qt/locale/bitsolo_pt.ts \
                src/qt/locale/bitsolo_ru.ts \
                src/qt/locale/bitsolo_sk.ts \
                src/qt/locale/bitsolo_sv.ts \
                src/qt/locale/bitsolo_vi.ts \
                src/qt/locale/bitsolo_zh_CN.ts \
                src/qt/locale/bitsolo_zh_TW.ts
