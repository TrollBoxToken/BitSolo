...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "BitSolo server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BSL features */
        {"bitsolo", "masternode", &masternode, true, true, false},
        {"bitsolo", "masternodelist", &masternodelist, true, true, false},
        {"bitsolo", "mnbudget", &mnbudget, true, true, false},
        {"bitsolo", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"bitsolo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitsolo", "mnsync", &mnsync, true, true, false},
        {"bitsolo", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"bitsolo", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitsolod, or the -server option to bitsolo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"BitSolo Alert\" admin@foo.com\n"),
...
{
    return "> bitsolo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55124/\n";
}
