/* src/config/bitsolo-config.h.  Generated from bitsolo-config.h.in by configure.  */
/* src/config/bitsolo-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://bitsolo.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitSolo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitSolo Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitsolo"
