...
/** Utility functions used by the BSL Qt UI.
 */
namespace GUIUtil
{
...
// Render BSL addresses in monospace font
...
// Parse "bitsolo:" URI into recipient object, return true on successful parsing
