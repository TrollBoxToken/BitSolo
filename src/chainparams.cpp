...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000e93c2f5ad4f3cb154f678648078627d8993c5e4324f82850ba835675d23"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1523116993, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 1000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "BitSolo cryptocurrency";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1523116993;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21033642;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000e93c2f5ad4f3cb154f678648078627d8993c5e4324f82850ba835675d23"));
        assert(genesis.hashMerkleRoot == uint256("0x415ce41033a79b5b374c0868ced357e7fa6608c132b5e0fa07f8ea7c39e06c8b"));
        

        vSeeds.push_back(CDNSSeedData("seed1.bitsolo.me", "seed1.bitsolo.me"));
        vSeeds.push_back(CDNSSeedData("seed2.bitsolo.me", "seed2.bitsolo.me"));
        vSeeds.push_back(CDNSSeedData("seed3.bitsolo.me", "seed3.bitsolo.me"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
...
public:
    CTestNetParams()
    {
        ...
        genesis.nNonce = 21037165;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000f4aebd810103f1980bf6b8a68b777a5742966302f22035c8b8ea9f2775f"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet BitSolo BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet BitSolo BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet BitSolo BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x1ec2d825e5ce8a25e431be7b394f0148f2f79e6b25ff8cbb90a92958aed1371e"));
