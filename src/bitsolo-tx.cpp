...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitSolo Core bitsolo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitsolo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitsolo transaction") + "\n" +
                               "  bitsolo-tx [options] -create [commands]   " + _("Create hex-encoded bitsolo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitsolo transaction
